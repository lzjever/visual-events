...
def test_ga_plan_defines_current_pc_delivery_gate_and_deferred_hardware_gate():
    ...
    assert_contains_all(
        ...
        [
            ...
            "pass/fail authority 是 `tools/run_cli_local_e2e.py --full-scene --all-scenes --head-state stationary --server-config configs/pc-ga-server.toml`",
...
def test_ga_plan_baseline_and_team_review_match_current_cli_state():
    ...
    assert_contains_all(
        ...
        [
            ...
            "Step 5 `run_cli_local_e2e` current PC core functional gate 已完成",
            "`tools/run_cli_local_e2e.py --full-scene --all-scenes --head-state stationary --server-config configs/pc-ga-server.toml`",
...
def test_ga_plan_keeps_native_runtime_loop_done_and_one_remaining_boundary():
    ...
    assert_contains_all(
        ...
        [
            ...
            "当前 PC core gate 的 pass/fail authority 是 `tools/run_cli_local_e2e.py --full-scene --all-scenes --head-state stationary --server-config configs/pc-ga-server.toml`",
