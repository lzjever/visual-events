...
- Production runner/lifecycle 自动化测试必须覆盖正式 start/run/shutdown/reconnect、signal/process cleanup、Botified task 启停、required head_state 模式、真实 DDS adapter wiring failure/fail-fast、DDS resource cleanup。
